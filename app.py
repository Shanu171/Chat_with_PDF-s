...
def get_conversation_chain():
    ...
    provided contex just say, "answer is not available in the context", don't provide the wrong answer\n\n
    Context:  \n {context}?\n
    Question: \n{question}\n
    ...
    model = ChatGoogleGenerativeAI(model  = "gemini-pro",temprature = 0.5)
